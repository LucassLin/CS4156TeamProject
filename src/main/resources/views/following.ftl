...
<div class="info-container">
  ...
  <div class="info-item"><i class="fa fa-youtube fa-fw w3-margin-right w3-large w3-text-teal"></i> Following ${user.getFollowingChannels()?size}</div>
  <div class="info-item"><i class="fa fa-heart fa-fw w3-margin-right w3-large w3-text-teal"></i> Interests ${user.getInterests()?size}</div>
</div>

<h2><i class="fa fa-youtube fa-fw w3-margin-right w3-large w3-text-teal"></i> Interests</h2>
<ul>
  <#list user.getInterests() as interest>
    <li>
      ${interest}
    </li>
  </#list>
